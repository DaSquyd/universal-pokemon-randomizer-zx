...
#DEFINE CONDITION_COLOR_FREEZE 0x7DEF ; #7B7BFF
...
Condition_Freeze:
    ldr     r0, [sp, #SP_IS_FADING_OUT]
    cmp     r0, #1
    bne     Condition_Freeze_Skip
    
    ldr     r3, =CONDITION_COLOR_FREEZE
    mov     r0, r4
    mov     r1, r5
    mov     r2, #8
    bl      BattleLevel::Mcss_SetPokeColor
    
Condition_Freeze_Skip:
    mov     r0, r4
    mov     r1, r5
    mov     r2, #4
    bl      BattleLevel::Unk_21E7000
    ...
    mov     r2, #2
    bl      BattleLevel::Unk_21E70A4
    b       Condition_CommonLink
    
    
Condition_Burn:
    ldr     r0, [sp, #SP_IS_FADING_OUT]
    cmp     r0, #1
    bne     Condition_Burn_Skip
...
Condition_Burn_Skip:
    b       Condition_CommonColor
    
    
Condition_Poison:
    ldr     r0, [sp, #SP_IS_FADING_OUT]
    cmp     r0, #1
    bne     Condition_Poison_Skip
