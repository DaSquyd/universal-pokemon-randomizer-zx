...
public class Moves {
    ...
    public static final int direClaw = 827;
    public static final int psyshieldBash = 828;
    public static final int powerShift = 829;
    public static final int stoneAxe = 830;
    public static final int springtideStorm = 831;
    public static final int mysticalPower = 832;
    public static final int ragingFury = 833;
    public static final int waveCrash = 834;
    public static final int chloroblast = 835;
    public static final int mountainGale = 836;
    public static final int victoryDance = 837;
    public static final int headlongRush = 838;
    public static final int barbBarrage = 839;
    public static final int esperWing = 840;
    public static final int bitterMalice = 841;
    public static final int shelter = 842;
    public static final int tripleArrows = 843;
    ...
    public static final int teraBlast = 851;
    public static final int silkTrap = 852;
    public static final int axeKick = 853;
    public static final int lastRespects = 854;
    public static final int luminaCrash = 855;
    public static final int orderUp = 856;
    public static final int jetPunch = 857;
    public static final int spicyExtract = 858;
    public static final int spinOut = 859;
    public static final int populationBomb = 860;
    public static final int iceSpinner = 861;
    public static final int glaiveRush = 862;
    public static final int revivalBlessing = 863;
    public static final int saltCure = 864;
    public static final int tripleDive = 865;
    public static final int mortalSpin = 866;
    public static final int doodle = 867;
    public static final int filletAway = 868;
    public static final int kowtowCleave = 869;
    public static final int flowerTrick = 870;
    public static final int torchSong = 871;
    public static final int aquaStep = 872;
    public static final int regingBull = 873;
    public static final int makeItRain = 874;
    public static final int psyblade = 875;
    public static final int hydroSteam = 876;
    public static final int ruination = 877;
    public static final int collisionCourse = 878;
    public static final int electroDrift = 879;
    public static final int shedTail = 880;
    public static final int chillyReception = 881;
    public static final int tidyUp = 882;
    public static final int snowscape = 883;
    public static final int pounce = 884;
    public static final int trailblaze = 885;
    public static final int chillingWater = 886;
    public static final int hyperDrill = 887;
    public static final int twinBeam = 888;
    public static final int rageFist = 889;
    public static final int armorCannon = 890;
    public static final int bitterBlade = 891;
    public static final int doubleShock = 892;
    public static final int gigatonHammer = 893;
    public static final int comeuppance = 894;
    public static final int aquaCutter = 895;
    public static final int blazingTorque = 896;
    public static final int wickedTorque = 897;
    public static final int noxiousTorque = 898;
    public static final int combatTorque = 899;
    public static final int magicalTorque = 900;
    public static final int bloodMoon = 901;
    public static final int matchaGotcha = 902;
    public static final int syrupBomb = 903;
    public static final int ivyCudgel = 904;
    public static final int electroShot = 905;
    public static final int teraStarstorm = 906;
    public static final int fickleBeam = 907;
    public static final int burningBulwark = 908;
    public static final int thunderclap = 909;
    public static final int mightyCleave = 910;
    public static final int tachyonCutter = 911;
    public static final int hardPress = 912;
    public static final int dragonCheer = 913;
    public static final int alluringVoice = 914;
    public static final int temperFlare = 915;
    public static final int supercellSlam = 916;
