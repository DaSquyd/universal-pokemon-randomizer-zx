...
public class Abilities {
    ...
    public static final int purifyingSalt = 272;
    public static final int wellBakedBody = 273;
    public static final int windRider = 274;
    public static final int guardDog = 275;
    public static final int rockyPayload = 276;
    public static final int windPower = 277;
    public static final int zeroToHero = 278;
    public static final int commander = 279;
    public static final int electromorphosis = 280;
    public static final int protosynthesis = 281;
    public static final int quarkDrive = 282;
    public static final int goodAsGold = 283;
    public static final int vesselOfRuin = 284;
    public static final int swordOfRuin = 285;
    public static final int tabletsOfRuin = 286;
    public static final int BeadsOfRuin = 287;
    public static final int OrichalcumPulse = 288;
    public static final int HadronEngine = 289;
    public static final int Opportunist = 290;
    public static final int cudChew = 291;
    public static final int sharpness = 292;
    public static final int supremeOverlord = 293;
    public static final int costar = 294;
    public static final int toxicDebris = 295;
    public static final int armorTail = 296;
    public static final int earthEater = 297;
    public static final int myceliumMight = 298;
    public static final int hospitality = 299;
    public static final int mindsEye = 300;
    public static final int embodyAspectTeal = 301;
    public static final int embodyAspectHeathflame = 302;
    public static final int embodyAspectWellspring = 303;
    public static final int embodyAspectCornerstone = 304;
    public static final int toxicChain = 305;
    public static final int supersweetSyrup = 306;
    public static final int teraShift = 307;
    public static final int teraShell = 308;
    public static final int teraformZero = 309;
    public static final int poisonPuppeteer = 310;
    public static final int MAX = poisonPuppeteer;
}
