...
public class ArmThumbFormat_08 extends ArmThumbFormat {
    public static final Identifier IDENTIFIER = new Identifier(0x5200, 0xF200);
    ...
    public String getName() {
        return "Load/store sign-extended byte/halfword";
    }
